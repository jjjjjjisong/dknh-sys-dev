...
-- select id, issue_no, client, client_id, author, author_id from public.documents where del_yn = 'N' order by created_at desc;
-- select id, document_id, name1, product_id from public.document_items where del_yn = 'N' order by document_id, seq;
-- select id, issue_no, client, client_id, product, product_id, doc_id from public.order_book where del_yn = 'N' order by created_at desc;
